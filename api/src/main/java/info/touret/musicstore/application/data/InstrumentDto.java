...
public record InstrumentDto(@Min(0) Long id, @NotEmpty String name, @NotEmpty String reference,
                            ...
                            @NotNull InstrumentTypeDto type, Double originalPrice, Boolean hasDiscount) {

    public InstrumentDto(@Min(0) Long id, @NotEmpty String name, @NotEmpty String reference, @NotEmpty String manufacturer, @Min(0) Double price, @NotEmpty String description, @NotNull InstrumentTypeDto type) {
