...
The workshop uses [OpenFeature](https://openfeature.dev/) as a vendor-agnostic abstraction layer to manage feature flags across both a Java backend and an Angular frontend, with [Go Feature Flag](https://gofeatureflag.org/) used as the underlying feature flag management platform.
