...
C4Container
    ...
    System_Boundary(system, "Music Store Application") {
        ...
        ContainerDb(go-feature-flag, "Feature Flag Repository", "go-feature-flag", "Stores and provide feature flag logic")
    ...
    Rel(gui, go-feature-flag, "Sends API requests to get feature flag", "JSON/HTTPS or GRPC")
    Rel(api, go-feature-flag, "Sends API requests to get feature flag", "JSON/HTTPS or GRPC")
